              ...
              >
                {field.type === 'image' ? (
                  ...
                  <>
                    {/* مربع الصورة */}
                    <Rect
                      width={field.style?.imageMaxWidth || 300}
                      height={field.style?.imageMaxHeight || 300}
                      offsetX={(field.style?.imageMaxWidth || 300) / 2}
                      offsetY={(field.style?.imageMaxHeight || 300) / 2}
                      ...
                      cornerRadius={field.style?.imageRounded ? Math.min((field.style?.imageMaxWidth || 300), (field.style?.imageMaxHeight || 300)) / 2 : 4}
                    ...
                    >
                      ...
                      {/* نص أبعاد الصورة */}
                      <Text
                        text={`${field.style?.imageMaxWidth || 300}×${field.style?.imageMaxHeight || 300}`}
                        fontSize={12}
                        fontFamily="Arial"
                        fill="#64748b"
                        width={field.style?.imageMaxWidth || 300}
